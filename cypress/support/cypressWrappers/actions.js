class Actions {
  ...
  scrollToBottom(element, timeoutPeriod) {
    element.scrollTo('bottom', {timeout: timeoutPeriod, ensureScrollable: false});
  }
  ...
  hideElement(element) {
    element.invoke('css', 'display', 'none');
  }
  ...
  hoverOnElementWithoutScroll(element) {
    element.realHover({position: 'center', scrollBehavior: false});
  }
  /**
